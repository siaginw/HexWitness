...
| IDA | IDAPython JSONL exporter | `ida-pro-mcp` / `idalib-mcp` | Contract complete; licensed-version acceptance required |
| Ghidra | Python JSONL exporter | External/user-selected | Contract complete; local-version acceptance required |
